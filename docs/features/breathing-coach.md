...
When no breathwork is running, the BC only contains the currently selected breathing pattern name, followed by the selected breathing pattern text below it. For example: Box breathing 4-4-4-4.
